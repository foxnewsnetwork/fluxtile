...
tests.TreeTest = function() { }
tests.TreeTest.__name__ = ["tests","TreeTest"];
tests.TreeTest.main = function() {
	var t = datastructures.Tree.Create(5);
	var t2 = t.Branch(12);
	var t3a = t2.Branch(34);
	var t3b = t2.Branch(25);
}
tests.TreeTest.prototype.__class__ = tests.TreeTest;
