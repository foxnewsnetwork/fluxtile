...
tests.TextControlTest = function() { }
tests.TextControlTest.__name__ = ["tests","TextControlTest"];
tests.TextControlTest.main = function() {
	var text = new controls.TextControl();
...
tests.TextControlTest.prototype.__class__ = tests.TextControlTest;
