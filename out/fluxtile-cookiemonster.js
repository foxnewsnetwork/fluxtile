...
monsters.Cookies = function(p) {
	...
	while( $it0.hasNext() ) {
		...
		this.inputs.push({ name : new js.JQuery("#" + nid), value : new js.JQuery("#" + vid)});
		monsters.Monster.ID += 1;
	}
...
monsters.Cookies.__name__ = ["monsters","Cookies"];
monsters.Cookies.__super__ = monsters.Monster;
for(var k in monsters.Monster.prototype ) monsters.Cookies.prototype[k] = monsters.Monster.prototype[k];
monsters.Cookies.prototype.__class__ = monsters.Cookies;
if(typeof tests=='undefined') tests = {}
tests.CookieMonsterTest = function() { }
tests.CookieMonsterTest.__name__ = ["tests","CookieMonsterTest"];
tests.CookieMonsterTest.main = function() {
	var cm = new monsters.Cookies();
	cm.Show();
}
tests.CookieMonsterTest.prototype.__class__ = tests.CookieMonsterTest;
Std = function() { }
Std.__name__ = ["Std"];
Std["is"] = function(v,t) {
